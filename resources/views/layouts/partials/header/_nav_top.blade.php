...
@can('panel.database')
    <li class="mr-2 nav-item">
        <a href="#" class="nav-link py-4 px-4 @if (Request::is('panel/clientes*')) active @endif" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">
            Clientes
        </a>
    </li>
@endcan
...
@can('panel.admin')
    ...
    <li class="mr-2 nav-item">
        <a href="#" class="nav-link py-4 px-4 @if (Request::is('panel/entrada-instrumentos*')) active @endif" data-toggle="tab" data-target="#kt_header_tab_3" role="tab">
            Entrada Instrumentos
        </a>
    </li>

    <li class="mr-2 nav-item">
        <a href="#" class="nav-link py-4 px-4 @if (Request::is('panel/expediente*')) active @endif" data-toggle="tab" data-target="#kt_header_tab_4" role="tab">
            Exp. de Calibración
        </a>
    </li>

    <li class="mr-2 nav-item">
        <a href="#" class="nav-link py-4 px-4 @if (Request::is('panel/calibracion*')) active @endif" data-toggle="tab" data-target="#kt_header_tab_5" role="tab">
            Calibración
        </a>
    </li>
