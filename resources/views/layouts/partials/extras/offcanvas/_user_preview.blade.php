<!-- begin::User Panel-->
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
				<h3 class="font-weight-bold m-0">Mi cuenta</h3>
							...
							@if(Auth::user())
								<a href="#" class="navi-item">
									<span class="navi-link p-0 pb-2">
										...
										<span class="navi-text text-muted text-hover-primary text-lowercase">{{Auth::user()->email}}</span>
									</span>
								</a>
								@endif
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<a href="#!" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								...
								<div class="text-muted">Ajustes de la cuenta</div>
							</div>
						</div>
					</a>
					<!--end:Item-->
					...
					<a href="#!" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">Mi rendimiento</div>
					...
					<a href="#!" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">Mis asignaciones</div>
								<div class="text-muted">Actividades programadas</div>
							</div>
						</div>
					</a>
					<!--end:Item-->
