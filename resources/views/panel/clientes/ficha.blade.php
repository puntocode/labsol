        ...
        <div class="card-body">
          ...
          <div class="card-body px-0">
            <div class="tab-content">
                        ...
                        <div class="row">
                          <div class="form-group col-md-6">
                            ...
                            <div class="form-control p-0 border-0 h-auto">
                              <span class="font-weight-bold">{{$cliente->razon_social}}</span>
                            </div>
                          </div>
                          ...
                          <div class="form-group col-md-6">
                            <label>RUC</label>
                            <div class="form-control p-0 border-0 h-auto">
                              <span class="font-weight-bold">{{$cliente->documento}}</span>
                            </div>
                          </div>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <div class="form-control p-0 border-0 h-auto">
                              <span class="font-weight-bold">{{$cliente->nombre_contacto}}</span>
                            </div>
                          </div>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <div class="form-control p-0 border-0 h-auto">
                              <span class="font-weight-bold">{{$cliente->telefono}}</span>
                            </div>
                          </div>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <div class="form-control p-0 border-0 h-auto">
                              <span class="font-weight-bold">{{$cliente->direccion}}</span>
                            </div>
                          </div>
                          @if(\Auth::user()->hasAnyRole(['administrador', 'jefatura_calidad']))
                            <div class="col-md-12">
              ...
              <div class="tab-pane fade" id="tab_facturacion" role="tabpanel" aria-labelledby="tab_facturacion">
                <!--begin: Datatable-->
