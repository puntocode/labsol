...
@section('content')
	...
	<div class="container-fluid">
		<h3 class="card-label mb-8">Clientes
			<small class="font-weight-lighter">| Crear</small>
		</h3>
			...
			<div class="col-lg-9 col-xl-10">
				...
				<div class="card card-custom mb-5">
					...
					<div class="card-body">
						...
						<form id="form-cliente" class="mb-5" method="POST" action="{{route('panel.clientes.store')}}" autocomplete="off">
							{{ csrf_field() }}
                            ...
                            <div class="d-flex form-group justify-content-between align-items-end m-0 row">
                                ...
                                <div>
                                    ...
                                    <button id="delete-form-contact" type="button" title="Agregar nueva fila" class="btn btn-sm font-weight-bolder btn-light-danger" disabled>
                                ...
                                <div class="row w-100 pl-4">
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="contact[0][direccion]">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <label>Nombre de Contacto<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="contact[0][nombre]" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" class="form-control" name="contact[0][email]">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <label>Telefono</label>
                                            <input type="number" class="form-control" name="contact[0][telefono]">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <hr>
							...
							<div class="d-flex justify-content-center mt-5 row">
                                <a href="{{route('panel.clientes.index')}}" class="btn btn-secondary mr-2" title="Volver a listado">Volver</a>
...
@section('scripts')
    ...
    <script>
        let contactId = 1;
        const msgToas = 'Cliente creado correctamente!!'
        const _method = 'POST'
        let create = true
    </script>
