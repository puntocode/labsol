...
class PatronSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Patron::create([
            'code' => 'PCE-07',
            'description' => 'Multicalibrador Eléctrico',
            ...
            'precision' => [
                ...
                ['title' => 'VAC', 'value' => ['0 V – 1 020 V: 0,035 %', '10 Hz – 500 kHz']],
                ['title' => 'IDC', 'value' => ['0 A – 30 A: 50 ppm']],
                ['title' => 'IAC', 'value' => ['0 A – 30 A: 0,06 %', '10 Hz – 10 kHz']],
                ['title' => 'R (P)', 'value' => ['0 Ω - 1 GΩ: 40 ppm']],
                ['title' => 'R (S)', 'value' => ['10 Ω - 10 MΩ: 0,03 %']],

            ],
            'error_max' => [
                ['title' => 'VDC', 'value' => ['± 25 ppm']],
                ['title' => 'VAC', 'value' => ['± 0,035 %']],
                ['title' => 'IDC', 'value' => ['± 50 ppm']],
                ['title' => 'IAC', 'value' => ['± 0,06 %']],
                ['title' => 'R (P)', 'value' => ['± 40 ppm']],
                ['title' => 'R (S)', 'value' => ['± 0,03 %']],
            ],
            'condition_id' => 1,
            'magnitude_id' => 5,
            'ubication' => 'Laboratorio',
